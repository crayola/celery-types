...
class Task(Generic[_P, _R]):
    ...
    def delay(self, *args: _P.args, **kwargs: _P.kwargs) -> celery.result.AsyncResult[_R]: ...
    def apply_async(
        self,
        args: tuple[Any, ...] | None = ...,
    ...
    def AsyncResult(self, task_id: str, **kwargs: Any) -> celery.result.AsyncResult[_R]: ...
    def signature(
    ...
    @overload
    def add_to_chord(self, sig: Signature[Any], lazy: Literal[False] = ...) -> EagerResult[Any]: ...
    def update_state(
        self,
        task_id: str | None = ...,
        state: str | None = ...,
